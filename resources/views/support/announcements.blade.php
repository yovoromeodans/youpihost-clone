    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <aside class="w-full lg:w-56 shrink-0 order-2 lg:order-1">
            ...
            <div>
                ...
                @php
                    $sidebarLinks = [
                        ['label' => 'My Support Tickets', 'href' => '#',                          'active' => false, 'color' => 'text-red-500',    'icon' => '<path d="M20 12V22H4V12"/><path d="M22 7H2v5h20V7z"/><path d="M12 22V7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/>'],
                        ['label' => 'Announcements',      'href' => route('announcements'),       'active' => true,  'color' => 'text-primary',    'icon' => '<path d="M22 12h-4l-3 9L9 3l-3 9H2"/>'],
                        ['label' => 'Knowledgebase',      'href' => route('knowledgebase'),       'active' => false, 'color' => 'text-primary',    'icon' => '<path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>'],
                        ['label' => 'Downloads',          'href' => '#',                          'active' => false, 'color' => 'text-primary',    'icon' => '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/>'],
                        ['label' => 'Network Status',     'href' => '#',                          'active' => false, 'color' => 'text-slate-500',  'icon' => '<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>'],
                        ['label' => 'Open Ticket',        'href' => route('contact'),             'active' => false, 'color' => 'text-primary',    'icon' => '<path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/>'],
                    ];
                @endphp
                ...
                <ul class="grid grid-cols-2 sm:grid-cols-3 gap-2 lg:hidden">
                    ...
                    <li>
                        <a href="{{ $link['href'] }}"
                           class="flex items-center gap-2 px-3 py-3 rounded-lg text-sm
                                  transition-all duration-150
                                  {{ $link['active']
                                      ? 'bg-blue-50 text-primary font-medium'
